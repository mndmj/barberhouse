...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Mar 2023 pada 15.43
...
CREATE TABLE `tbl_transaksi` (
  ...
  `id_bb` int(11) NOT NULL,
  `id_user` int(11) NOT NULL,
  `waktu_antrian` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `tbl_detail_pemilik`
  MODIFY `id_detail_pemilik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tbl_transaksi`
  ADD CONSTRAINT `tbl_transaksi_ibfk_1` FOREIGN KEY (`id_bb`) REFERENCES `tbl_bb` (`id_bb`),
