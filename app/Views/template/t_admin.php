...
<head>
    ...
    <title><?= $_SERVER['APP_NAME'] ?>-<?= $subtitle ?></title>
    ...
    <script src="<?= base_url('assets') ?>/js/bb.main.js"></script>
    <script>
        function setRupiah(id, number) {
            $(id).html("Rp " + getRupiah(number));
        }
    </script>
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-light-primary" id="navbarToggleExternalContent">
